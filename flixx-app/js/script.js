...
async function search() {
    ...
    if (global.search.term !== '' && global.search.term !== null) {
        ...
        if (results.length
            === 0) {
            showAlert("No movie found with this name")
            return
        }
...
function displaySearchResults(results) {
    ...
    } else if (global.search.type === 'show') {
...
async function displayTVShowDetails() {
 ...
 />`
  ...
  <div class="details-bottom">
    <h2>Movie Info</h2>
    <ul>
      <li><span class="text-secondary">Budget:</span> $${addCommasToNum(show.budget)}</li>
      <li><span class="text-secondary">Revenue:</span> $${addCommasToNum(show.revenue)}</li>
